  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          className="absolute top-1/4 right-[8%] w-64 h-64 rounded-full opacity-10 blur-3xl animate-[blobFloat_8s_ease-in-out_infinite_alternate]"
          style={{ backgroundColor: accentText }}
        />
        <div
          className="absolute bottom-1/4 left-[6%] w-48 h-48 rounded-full opacity-10 blur-3xl animate-[blobFloat_11s_ease-in-out_infinite_alternate-reverse]"
          style={{ backgroundColor: accentText }}
        />
        ...
        <div className="relative z-10 w-full max-w-[1380px] mx-auto px-4 sm:px-6 pt-24 pb-16 md:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center min-h-[80vh]">
            ...
            <div className="lg:col-span-5 flex flex-col gap-4 animate-[slideUp_0.8s_cubic-bezier(0.16,1,0.3,1)_both]">
              ...
              <div
                style={{ backgroundColor: accentText }}
                className="w-14 h-[1.5px] opacity-70"
              />
              <p
                style={{ color: "rgba(255,255,255,0.75)" }}
                className="text-sm font-light leading-relaxed max-w-sm"
              >
                Our multilingual reservations team is always ready to assist you
                with planning your perfect stay in Bali.
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        ...
                        >
                          {[
                            ...
                            <option
                              ...
                              className={
                                isDark
                                  ? "bg-[#010e22] text-white"
                                  : "bg-white text-[#011434]"
                              }
                            >
                              {v}
                            </option>
                  ...
                  >
                    <textarea
                      required
                      rows={4}
                      placeholder="Write down your message or inquiries"
                      value={message}
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 order-2 lg:order-1 relative h-[280px] sm:h-[380px] lg:h-[500px] rounded-sm overflow-hidden group shadow-lg">
            ...
            <div
              className="absolute bottom-5 left-5 z-10 px-3 py-1.5 rounded-sm"
              style={{
                background: isDark
                  ? "rgba(1,14,34,0.7)"
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 flex flex-col justify-center">
            <div className="mb-6">
              ...
              <div
                style={{ backgroundColor: accentText }}
                className="w-12 h-[1px] opacity-60"
              />
            </div>
            ...
            >
              Poodja&apos;s multilingual Reservations team are always available
              to help you with your travel planning.
            </p>
            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <div className="flex flex-col gap-1 text-sm font-light">
                  ...
                  <a
                    href="https://wa.me/6282145811275"
                    target="_blank"
              ...
              <div>
                ...
                <div className="flex flex-col gap-2.5 text-sm font-light">
                  {[
                    {
                      sub: "Villas, Hotels & Villa Complex Management Enquiry",
                      mail: "hello@thepoodja.com",
                    },
                    { sub: "Agent Contracting", mail: "sales@thepoodja.com" },
                    {
                      sub: "General Reservation",
                      mail: "reservation@thepoodja.com",
                    },
                    { sub: "Event Reservation", mail: "events@thepoodja.com" },
                    {
                      sub: "Guest Service Assistance",
                      mail: "concierge@thepoodja.com",
                    },
                  ].map(({ sub, mail }) => (
                    <div key={mail} className="flex flex-col">
                      ...
                      <a
                        href={`mailto:${mail}`}
                        className="hover:underline self-start font-medium transition-opacity hover:opacity-80"
                        style={{ color: mainText }}
                      >
                        {mail}
                      </a>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            >
              If you prefer to enquire or consult a property offline, we are
              available to meet at our office.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div>
                ...
                >
                  Jalan Raya Seminyak No. 88, Legian,
                  <br />
          ...
          <div className="lg:col-span-7 relative h-[320px] md:h-[420px] rounded-sm overflow-hidden shadow-md">
            <iframe
              ...
              style={{
                border: 0,
                filter: isDark
                  ? "grayscale(1) invert(0.88) hue-rotate(180deg)"
                  : "none",
      ...
      >
        <div className="max-w-[1380px] mx-auto px-6 text-center">
          ...
          <div
            style={{ backgroundColor: accentText }}
            className="w-8 h-[1px] mx-auto opacity-60 mb-10"
          />
            ...
            {[
              ...
              <a
                ...
                style={{
                  ...
                  backdropFilter: "blur(8px)",
                  backgroundColor: isDark
                    ? "rgba(252,213,123,0.04)"
                    : "rgba(139,107,46,0.04)",
                }}
              ...
              >
                <Icon name={icon} size={20} style={{ color: "currentColor" }} />
              </a>
            ))}
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-[fadeIn_0.3s_ease]">
          ...
          >
            ...
            <p
              ...
              className="text-sm font-light leading-relaxed mb-6"
            >
              Your message has been sent successfully. Our multilingual
              reservations team will review it and get back to you shortly.
            </p>
            <button
